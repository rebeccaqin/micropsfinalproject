...
#define GPIOA1 ((GPIO1_TypeDef *) GPIOA_BASE)
#define GPIOB1 ((GPIO1_TypeDef *) GPIOB_BASE)
#define GPIOC1 ((GPIO1_TypeDef *) GPIOC_BASE)

///////////////////////////////////////////////////////////////////////////////
// Function prototypes
///////////////////////////////////////////////////////////////////////////////

void pinMode(GPIO1_TypeDef *, int pin, int function);

int digitalRead(GPIO1_TypeDef *, int pin);

void digitalWrite(GPIO1_TypeDef *, int pin, int val);

void togglePin(GPIO1_TypeDef *, int pin);
